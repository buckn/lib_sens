...
pub struct GamesTuple(CSGO, PORTAL2);
...
impl SensProfile {
    pub fn new() -> Self {
        Self {
            game_structs_tuple: GamesTuple(CSGO::new(), PORTAL2::new()),
            number_of_supported_games: 1,
        }
    }
    ...
    pub fn fs_read_game_sens(&mut self, game: SupportedGames) {
        match game {
            ...
            SupportedGames::PORTAL2 => self.game_structs_tuple.1.set_sens(self.game_structs_tuple.0.fs_read()),
        }
    }
